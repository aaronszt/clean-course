(() => {
    ...
    const numbersOfTempCelsius = [33.6, 12.34];
    ...
    const emailOfUser = users.map( user => user.email );
    ...
    const startExercises = new Date().getTime();
    const endExercises = new Date().getTime() - startExercises;
